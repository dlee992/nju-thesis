...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{master/introduction.tex}
\input{master/survey.tex}
\input{master/problem.tex}
\input{master/design.tex}
\input{master/system.tex}
\input{master/evaluation.tex}
\input{master/conclusion.tex}
%\include{master/.tex}
